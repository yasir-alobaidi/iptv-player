...
class EpgPrograms extends Table with TableInfo<EpgPrograms, EpgProgramsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgPrograms(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  EpgPrograms createAlias(String alias) {
    return EpgPrograms(attachedDatabase, alias);
  }
...
class ProgramsFts extends Table
    with
        TableInfo<ProgramsFts, ProgramsFtsData>,
        VirtualTableInfo<ProgramsFts, ProgramsFtsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => const {};
  @override
  ProgramsFtsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProgramsFtsData(
      title: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}title'],
      ),
...
class ProgramsFtsData extends DataClass implements Insertable<ProgramsFtsData> {
  final String? title;
  final String? subtitle;
  final String? description;
  const ProgramsFtsData({this.title, this.subtitle, this.description});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  factory ProgramsFtsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ProgramsFtsData copyWithCompanion(ProgramsFtsCompanion data) {
    return ProgramsFtsData(
      title: data.title.present ? data.title.value : this.title,
      subtitle: data.subtitle.present ? data.subtitle.value : this.subtitle,
      description: data.description.present
  ...
  @override
  String toString() {
    return (StringBuffer('ProgramsFtsData(')
          ..write('title: $title, ')
          ..write('subtitle: $subtitle, ')
          ..write('description: $description')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProgramsFtsData &&
          other.title == this.title &&
          other.subtitle == this.subtitle &&
          other.description == this.description);
}

class ProgramsFtsCompanion extends UpdateCompanion<ProgramsFtsData> {
  final Value<String?> title;
  final Value<String?> subtitle;
  final Value<String?> description;
  final Value<int> rowid;
  ...
  static Insertable<ProgramsFtsData> custom({
    Expression<String>? title,
    Expression<String>? subtitle,
    Expression<String>? description,
    Expression<int>? rowid,
...
class EpgImports extends Table with TableInfo<EpgImports, EpgImportsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgImports(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  EpgImportsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EpgImportsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  EpgImports createAlias(String alias) {
    return EpgImports(attachedDatabase, alias);
  }
...
class EpgImportsData extends DataClass implements Insertable<EpgImportsData> {
  final int id;
  final String sourceId;
  ...
  factory EpgImportsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EpgImportsData copyWithCompanion(EpgImportsCompanion data) {
    return EpgImportsData(
      id: data.id.present ? data.id.value : this.id,
      sourceId: data.sourceId.present ? data.sourceId.value : this.sourceId,
  ...
  @override
  String toString() {
    return (StringBuffer('EpgImportsData(')
          ..write('id: $id, ')
          ..write('sourceId: $sourceId, ')
...
class EpgImportsCompanion extends UpdateCompanion<EpgImportsData> {
  final Value<int> id;
  final Value<String> sourceId;
  ...
  EpgImportsCompanion.insert({
    ...
    this.isLive = const Value.absent(),
       ...
       startedAt = Value(startedAt);
  static Insertable<EpgImportsData> custom({
    Expression<int>? id,
    Expression<String>? sourceId,
...
class EpgChannels extends Table with TableInfo<EpgChannels, EpgChannelsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgChannels(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  EpgChannels createAlias(String alias) {
    return EpgChannels(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['UNIQUE(source_id, xmltv_id)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class EpgChannelsStaging extends Table
    with TableInfo<EpgChannelsStaging, EpgChannelsStagingData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgChannelsStaging(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> importRun = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES epg_imports(id)ON DELETE CASCADE',
  );
  late final GeneratedColumn<String> xmltvId = GeneratedColumn<String>(
    'xmltv_id',
    aliasedName,
  ...
  @override
  EpgChannelsStagingData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EpgChannelsStagingData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  EpgChannelsStaging createAlias(String alias) {
    return EpgChannelsStaging(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['UNIQUE(import_run, xmltv_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class EpgChannelsStagingData extends DataClass
    implements Insertable<EpgChannelsStagingData> {
  final int id;
  final int importRun;
  final String xmltvId;
  final String? displayName;
  final String? iconUrl;
  const EpgChannelsStagingData({
    required this.id,
  ...
  factory EpgChannelsStagingData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EpgChannelsStagingData copyWith({
    int? id,
    int? importRun,
    String? xmltvId,
    Value<String?> displayName = const Value.absent(),
    Value<String?> iconUrl = const Value.absent(),
  }) => EpgChannelsStagingData(
    id: id ?? this.id,
  ...
  EpgChannelsStagingData copyWithCompanion(EpgChannelsStagingCompanion data) {
    return EpgChannelsStagingData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('EpgChannelsStagingData(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is EpgChannelsStagingData &&
          other.id == this.id &&
...
class EpgChannelsStagingCompanion
    extends UpdateCompanion<EpgChannelsStagingData> {
  final Value<int> id;
  ...
  EpgChannelsStagingCompanion.insert({
    ...
    this.iconUrl = const Value.absent(),
       ...
       xmltvId = Value(xmltvId);
  static Insertable<EpgChannelsStagingData> custom({
    Expression<int>? id,
...
class EpgProgramsStaging extends Table
    with TableInfo<EpgProgramsStaging, EpgProgramsStagingData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgProgramsStaging(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  EpgProgramsStagingData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EpgProgramsStagingData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  EpgProgramsStaging createAlias(String alias) {
    return EpgProgramsStaging(attachedDatabase, alias);
  }
...
class EpgProgramsStagingData extends DataClass
    implements Insertable<EpgProgramsStagingData> {
  final int id;
  final int importRun;
  final String epgChannelId;
  final int startUtc;
  ...
  factory EpgProgramsStagingData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EpgProgramsStagingData copyWith({
    int? id,
    int? importRun,
    String? epgChannelId,
    int? startUtc,
  ...
  EpgProgramsStagingData copyWithCompanion(EpgProgramsStagingCompanion data) {
    return EpgProgramsStagingData(
      id: data.id.present ? data.id.value : this.id,
      importRun: data.importRun.present ? data.importRun.value : this.importRun,
      epgChannelId: data.epgChannelId.present
  ...
  @override
  String toString() {
    return (StringBuffer('EpgProgramsStagingData(')
          ..write('id: $id, ')
          ..write('importRun: $importRun, ')
          ..write('epgChannelId: $epgChannelId, ')
          ..write('startUtc: $startUtc, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is EpgProgramsStagingData &&
          other.id == this.id &&
          other.importRun == this.importRun &&
          other.epgChannelId == this.epgChannelId &&
          other.startUtc == this.startUtc &&
...
class EpgProgramsStagingCompanion
    extends UpdateCompanion<EpgProgramsStagingData> {
  final Value<int> id;
  final Value<int> importRun;
  final Value<String> epgChannelId;
  final Value<int> startUtc;
  ...
  EpgProgramsStagingCompanion.insert({
    ...
    this.category = const Value.absent(),
       ...
       endUtc = Value(endUtc),
       title = Value(title);
  static Insertable<EpgProgramsStagingData> custom({
    Expression<int>? id,
    Expression<int>? importRun,
    Expression<String>? epgChannelId,
    Expression<int>? startUtc,
...
class EpgMappings extends Table with TableInfo<EpgMappings, EpgMappingsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgMappings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sourceId = GeneratedColumn<String>(
    'source_id',
    aliasedName,
    false,
  ...
  @override
  EpgMappingsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EpgMappingsData(
      sourceId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}source_id'],
      )!,
  ...
  @override
  EpgMappings createAlias(String alias) {
    return EpgMappings(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(source_id, channel_remote_key)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class EpgMappingsData extends DataClass implements Insertable<EpgMappingsData> {
  final String sourceId;
  final String channelRemoteKey;
  final String xmltvId;
  final String updatedAt;
  const EpgMappingsData({
    required this.sourceId,
  ...
  factory EpgMappingsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EpgMappingsData copyWithCompanion(EpgMappingsCompanion data) {
    return EpgMappingsData(
      sourceId: data.sourceId.present ? data.sourceId.value : this.sourceId,
  ...
  @override
  String toString() {
    return (StringBuffer('EpgMappingsData(')
          ..write('sourceId: $sourceId, ')
...
class EpgMappingsCompanion extends UpdateCompanion<EpgMappingsData> {
  final Value<String> sourceId;
  ...
  EpgMappingsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       xmltvId = Value(xmltvId),
       updatedAt = Value(updatedAt);
  static Insertable<EpgMappingsData> custom({
    Expression<String>? sourceId,
...
class EpgMatches extends Table with TableInfo<EpgMatches, EpgMatchesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EpgMatches(this.attachedDatabase, [this._alias]);
  ...
  @override
  EpgMatchesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return EpgMatchesData(
  ...
  @override
  EpgMatches createAlias(String alias) {
    return EpgMatches(attachedDatabase, alias);
  }
...
class EpgMatchesData extends DataClass implements Insertable<EpgMatchesData> {
  final int channelId;
  final String sourceId;
  final String xmltvId;
  final String rule;
  const EpgMatchesData({
  ...
  factory EpgMatchesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EpgMatchesData copyWithCompanion(EpgMatchesCompanion data) {
    return EpgMatchesData(
  ...
  @override
  String toString() {
    return (StringBuffer('EpgMatchesData(')
...
class EpgMatchesCompanion extends UpdateCompanion<EpgMatchesData> {
  ...
  EpgMatchesCompanion.insert({
    ...
    required String rule,
       ...
       xmltvId = Value(xmltvId),
       rule = Value(rule);
  static Insertable<EpgMatchesData> custom({
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final EpgPrograms epgPrograms = EpgPrograms(this);
  late final ProgramsFts programsFts = ProgramsFts(this);
  late final EpgImports epgImports = EpgImports(this);
  late final EpgChannels epgChannels = EpgChannels(this);
  late final EpgChannelsStaging epgChannelsStaging = EpgChannelsStaging(this);
  late final EpgProgramsStaging epgProgramsStaging = EpgProgramsStaging(this);
  late final EpgMappings epgMappings = EpgMappings(this);
  late final EpgMatches epgMatches = EpgMatches(this);
