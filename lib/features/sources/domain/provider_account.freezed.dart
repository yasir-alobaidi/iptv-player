...
/// `Active`, `Expired`, `Banned`, `Disabled`, as the panel words it.
 ...
 DateTime? get expiresAt; bool get isTrial; int? get activeConnections; int? get maxConnections;/// The panel's time zone name, e.g. `Europe/London`.
...
int get hashCode {
  final _this = this as ProviderAccount;
  return Object.hash(runtimeType,_this.status,_this.expiresAt,_this.isTrial,_this.activeConnections,_this.maxConnections,_this.serverTimezone);
}

@override
String toString() {
  final _this = this as ProviderAccount;
  return 'ProviderAccount(status: ${_this.status}, expiresAt: ${_this.expiresAt}, isTrial: ${_this.isTrial}, activeConnections: ${_this.activeConnections}, maxConnections: ${_this.maxConnections}, serverTimezone: ${_this.serverTimezone})';
}
...
@useResult
$Res call({
 String? status, DateTime? expiresAt, bool isTrial, int? activeConnections, int? maxConnections, String? serverTimezone
});
...
/// Create a copy of ProviderAccount
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = freezed,Object? expiresAt = freezed,Object? isTrial = null,Object? activeConnections = freezed,Object? maxConnections = freezed,Object? serverTimezone = freezed,}) {
...
as int?,serverTimezone: freezed == serverTimezone ? _self.serverTimezone : serverTimezone // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? status,  DateTime? expiresAt,  bool isTrial,  int? activeConnections,  int? maxConnections,  String? serverTimezone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProviderAccount() when $default != null:
return $default(_that.status,_that.expiresAt,_that.isTrial,_that.activeConnections,_that.maxConnections,_that.serverTimezone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? status,  DateTime? expiresAt,  bool isTrial,  int? activeConnections,  int? maxConnections,  String? serverTimezone)  $default,) {final _that = this;
switch (_that) {
case _ProviderAccount():
return $default(_that.status,_that.expiresAt,_that.isTrial,_that.activeConnections,_that.maxConnections,_that.serverTimezone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? status,  DateTime? expiresAt,  bool isTrial,  int? activeConnections,  int? maxConnections,  String? serverTimezone)?  $default,) {final _that = this;
switch (_that) {
case _ProviderAccount() when $default != null:
return $default(_that.status,_that.expiresAt,_that.isTrial,_that.activeConnections,_that.maxConnections,_that.serverTimezone);case _:
  return null;
...
class _ProviderAccount implements ProviderAccount {
  const _ProviderAccount({this.status, this.expiresAt, this.isTrial = false, this.activeConnections, this.maxConnections, this.serverTimezone});
...
@override
int get hashCode {
    return Object.hash(runtimeType,status,expiresAt,isTrial,activeConnections,maxConnections,serverTimezone);
}

@override
String toString() {
    return 'ProviderAccount(status: $status, expiresAt: $expiresAt, isTrial: $isTrial, activeConnections: $activeConnections, maxConnections: $maxConnections, serverTimezone: $serverTimezone)';
}
...
/// Create a copy of ProviderAccount
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = freezed,Object? expiresAt = freezed,Object? isTrial = null,Object? activeConnections = freezed,Object? maxConnections = freezed,Object? serverTimezone = freezed,}) {
